...
//authenticated hai toh home page pe le jaayenge 
  useEffect(() => {
    if (isAuthenticated) {
      navigate('/');
    }
  }, [isAuthenticated, navigate]);  //is authenticated false hoga toh useffect call hoga aur signup page pe aajayenge 
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-base-200"> {/* Added a light bg for contrast */}
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          <h2 className="card-title justify-center text-3xl mb-6">CodeMaster</h2> {/* Added mb-6 for spacing */}
